"use client" // Importante: useRouter necesita ser Client Component
      ...
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="bg-muted relative hidden md:block">
            <Image src={Loginbg} alt="Image" className="absolute inset-0 h-full w-full object-cover dark:brightness-[0.2]" />
          </div>
        </CardContent>
      </Card>
    </div>
